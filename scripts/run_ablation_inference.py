...
CONDITION_CONFIGS = {
    ...
    "mixed_teacher_threshold_balanced": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_threshold_balanced.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_labeled_finish": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_labeled_finish.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_labeled_guarded": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_labeled_guarded.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    ...
    "mixed_teacher_prototype_balanced": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_prototype_balanced.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_prototype_guarded": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_prototype_guarded.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_hybrid_extra_balanced": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_hybrid_extra_balanced.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_hybrid_style_distill_balanced": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_hybrid_style_distill_balanced.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_hybrid_style_distill_w010_balanced": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_hybrid_style_distill_w010_balanced.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_hybrid_style_distill_w050_balanced": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_hybrid_style_distill_w050_balanced.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_hybrid_style_distill_targetmask_balanced": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_hybrid_style_distill_targetmask_balanced.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_hybrid_style_distill_labeled_warmup": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_hybrid_style_distill_labeled_warmup.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_cvrare_hybrid_style_distill_labeled_warmup": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_cvrare_hybrid_style_distill_labeled_warmup.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_cvrare_decoder_proto_labeled_warmup": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_cvrare_decoder_proto_labeled_warmup.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_cvrare_decoder_proto_w005_labeled_warmup": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_cvrare_decoder_proto_w005_labeled_warmup.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_cvrare_failure_targeted_style_teacher_labeled_warmup": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_cvrare_failure_targeted_style_teacher_labeled_warmup.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_cvrare_antineutral_labeled_warmup": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_cvrare_antineutral_labeled_warmup.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
    "mixed_teacher_cvrare_audio_calibrated_labeled_warmup": {
        "checkpoint": "embeddings/openvoice_vae_mixed_teacher_cvrare_audio_calibrated_labeled_warmup.pt",
        "styles": FULL_STYLES,
        "style_to_index": {style: idx for idx, style in enumerate(FULL_STYLES)},
        "control_mode": "labeled",
    },
